...
* **$S_2 = \{\text{"John"}, \text{"Michael"}, \text{"Saun"}\}$** (a set of names)
* **$S_3 = \{\text{2023-10-02}, \text{2022-07-11}, \text{2025-01-12}, \text{2019-03-27}, \text{2026-12-03}\}$** (a set of dates)
...
<mark>Now that you understand `FROM` (which tables to get data from), `WHERE` (how to filter rows), and `SELECT` (which columns to output), what do you think is the logical order in which a database executes them?</mark>[^3]
...
<mark>Now that you understand `ORDER BY`, `LIMIT/OFFSET`, and `GROUP BY` in addition to `FROM`, `SELECT` and `WHERE`, what do you think is the logical order in which a database executes all of them?</mark>[^4]
...
<img src="/assets/images/schema2023-v2.png" alt="first example" height="600" style="border: 1px solid black;">
</div>
...
<img src="/assets/images/advanced_example1_query_plan.png" alt="first example" height="600" style="border: 1px solid black;">
</div>
...
Physically,
<div style="text-align: left;">
<img src="/assets/images/advanced_example2_query_plan.png" alt="first example" height="600" style="border: 1px solid black;">
</div>
...
<div style="text-align: left;">
<img src="/assets/images/btree.png" alt="first example" style="border: 1px solid black;">
</div>
