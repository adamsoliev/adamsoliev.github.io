...
There's plenty of material online about storage engines (eg see [this](https://www.yugabyte.com/blog/a-busy-developers-guide-to-database-storage-engines-the-basics/) and [its follow-up](https://www.yugabyte.com/blog/a-busy-developers-guide-to-database-storage-engines-advanced-topics/)).
...
- B+tree provides balanced read and write performance, while LSM-tree is optimized for high write throughput. In addition to the workload type, other factors, such as concurrency control, also have a significant impact on storage engine performance (eg see [this](https://www.cs.cmu.edu/~pavlo/blog/2023/04/the-part-of-postgresql-we-hate-the-most.html))
...
<img src="/assets/images/storage_hierarchy.png" alt="first example" style="border: 0px solid black; width: 80%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/hdd_3d.png" alt="first example" style="border: 0px solid black; width: 60%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/innodb_se.png" alt="first example" style="border: 0px solid black; width: 70%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/mysql_btree.png" alt="first example" style="border: 0px solid black; width: 100%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/postgres_se.png" alt="first example" style="border: 0px solid black; width: 80%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/pg_page_layout.png" alt="first example" style="border: 0px solid black; width: 60%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/btree.png" alt="first example" style="border: 0px solid black; width: 100%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/data_layout.jpg" alt="first example" style="border: 0px solid black; width: 60%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/linux_io_interfaces.png" alt="first example" style="border: 0px solid black; width: 60%; height: auto;">
</div>
...
<div style="text-align: center;">
<img src="/assets/images/io_uring_modes.png" alt="first example" style="border: 0px solid black; width: 60%; height: auto;">
</div>
